...
namespace SimpleETL
{
    public class KafkaSource : DataSource
    {
        ...
        private readonly int _maxReadRows, _maxRunTime;
        ...
        public KafkaSource(string brokersList, string topicsList, int maxReadRows = 0, int maxRunTime = 0)
        {
